...
% IEEE TAES submission version (IEEEtran journal class). FORMAT-ONLY reflow
% of main.tex: no content, number, citation, figure, or table changed.
% The two leaderboard tables (tab_battery, tab_sensor) are inlined here as
% full-width table* floats from ../controller_study/tables/ verbatim, so the
% TAES version and the controller study can never disagree.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\title{The Settled-Gate Spacecraft Fault-Tolerant-Control Benchmark:
...
\begin{IEEEkeywords}
benchmark, fault-tolerant control, spacecraft attitude control, reproducibility, evaluation methodology
\end{IEEEkeywords}
...
\includegraphics[width=\linewidth]{figs/fig_leaderboard.pdf}
...
% Inlined verbatim from ../controller_study/tables/tab_battery.tex
...
% Inlined verbatim from ../controller_study/tables/tab_sensor.tex
...
\bibitem{OIG2023DSN} NASA Office of Inspector General. ``Audit of NASA's Deep Space Network.'' Report IG-23-016, 2023.
\end{thebibliography}
